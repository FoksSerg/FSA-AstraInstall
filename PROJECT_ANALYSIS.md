...
**Текущая версия:** V2.2.59 (2025.10.15)  
**Архитектура:** UniversalProcessRunner v2.0.0  
**Размер основного файла:** ~520KB (10,243 строки)  
**Классов:** 18  
**Методов:** 275+
...
**Размер:** ~520KB (10,243 строки)  
**Архитектура:** UniversalProcessRunner v2.0.0

**Основные классы (18 классов):**
...
|-----------|--------|--------|------------|
| `astra_automation.py` | ~520KB | 10,243 | Основной модуль с GUI и автоматизацией |
...
### **Система версионирования**
- **Версия проекта:** V2.2.X (MAJOR.MINOR.КОЛИЧЕСТВО_КОММИТОВ)
