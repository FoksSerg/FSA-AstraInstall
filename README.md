...
**Версия:** V5.0.385 (2026-04-15 00:20)  
...
**[Скачать установщик `FSA-AstraInstall-Bundle` (последняя версия)](../../releases/latest)**  
...
## 🏗️ Архитектура (63066 строк кода)
...
│   ├── Run/                       # 🚀 Точка входа (181 строка)
│   │   └── FSA-AstraInstall.py   # Главный исполняемый файл
│   │
│   ├── core/                      # ⚙️ Ядро системы (6,760 строк)
...
│   │
│   ├── managers/                  # 📋 Менеджеры (5,988 строк)
...
│   │
│   ├── runtime/                   # 🏃 Среда выполнения (2,056 строк)
...
│   │
│   ├── updater/                   # 🔄 Обновления (1,214 строк)
