# FSA-AstraInstall Automation V2.2.6061 (2025.10.15)

## Описание проекта

Автоматизированная система для обновления Astra Linux с установкой Wine и Astra.IDE через графический интерфейс с использованием новой архитектуры **UniversalProcessRunner**.
...
- **UniversalProcessRunner** - централизованное управление всеми процессами
- **SystemUpdater** - отдельный класс для обновления Linux пакетов
- **Перехват системных вызовов** - print(), subprocess.run(), logging через единый класс
...
8. **Установка Astra.IDE** - среда разработки
9. **Завершение** - отчет о результатах
...
- ✅ Реализована установка Wine и Astra.IDE через GUI
...
- ✅ Возможность удаления установленных компонентов Wine и Astra.IDE
- ✅ Автоматическое управление зависимостями при удалении (Wine → WINEPREFIX → Astra.IDE)
...
#### 🏷️ Версия проекта: V2.2.6061X
- **MAJOR** (V2.X.X) - кардинальные изменения архитектуры
- **MINOR** (V2.2.6061X) - новые функции, улучшения  
- **PATCH** (V2.2.6061X) - количество коммитов (сохраненных изменений)
...
├── astra_install.sh: V2.2.6061 (2025.10.14) ← изменен вчера
├── astra_update.sh: V2.2.6061 (2025.10.13) ← изменен позавчера
