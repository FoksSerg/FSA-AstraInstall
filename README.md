...
**Версия:** V5.5.400 (2026-04-30 16:16)  
...
*Информация о версии, документация и системный мониторинг (диск/память/CPU с визуальными индикаторами на активной вкладке)*
...
sudo ~/Astra/FSA-AstraInstall --console
