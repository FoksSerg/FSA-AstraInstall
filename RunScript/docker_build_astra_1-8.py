...
# -*- coding: utf-8 -*-
"""
Скрипт автоматической сборки FSA-AstraInstall на удаленном Docker для платформы astra-1.8
Версия: V3.4.176 (2025.12.07)
...
if __name__ == "__main__":
    try:
        ...
        # Устанавливаем параметры для сборки на удаленном Docker для astra-1.8
        sys.argv = [
            sys.argv[0],
        ...
        print("=== Платформа: astra-1.8 (Debian Bookworm) ===")
