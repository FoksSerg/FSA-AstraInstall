...
# Версия проекта: V3.6.200 (2025.12.22)
...
12. **Обновление дат релиза и версий в измененных файлах:** 
...
14. **Обновление версий проекта в ключевых файлах:** 
...
# ШАГ 12: Обновляем дату релиза и версии в измененных файлах
...
echo "=== ШАГ 12: Обновление дат релиза и версий в измененных файлах ==="
...
# ШАГ 14: Обновляем версию проекта в ключевых файлах
echo "=== ШАГ 14: Обновление версий проекта в ключевых файлах ==="
# КРИТИЧНО: Проверка директории проекта
PROJECT_DIR="/Volumes/FSA-PRJ/Project/FSA-AstraInstall"
[ "$(basename $(pwd))" != "FSA-AstraInstall" ] && cd "$PROJECT_DIR" || true
[ "$(basename $(pwd))" != "FSA-AstraInstall" ] && stop_on_error "Не удалось перейти в директорию проекта" || true
